...
export const SCORE_GUIDE = [
  {
    ...
    label: 'Leading',
    range: [130, 150],
    description: 'Ready for strategic AI. Review any dimension below 20 — even a high total with one low dimension hides a critical gap. Benchmark against AI leaders in your sector.',
  },
  {
    id: 'operational',
    label: 'Operational',
    range: [105, 129],
    description: 'AI projects can proceed in stronger dimensions. Build a 90-day plan to address dimensions scoring below 18. Revisit in 3 months.',
  },
  {
    id: 'emerging',
    label: 'Emerging',
    range: [75, 104],
    description: 'Limit AI to low-risk experiments. Invest 6–12 months in foundational readiness. Use the dimension playbooks. Re-assess every 90 days.',
  },
  {
    id: 'nascent',
    label: 'Nascent',
    range: [0, 74],
    description: 'Do not commit to significant AI investment. Fundamental gaps will cause projects to fail. Address Strategy and Data dimensions first. Re-assess in 90 days.',
  },
]
