...
/**
 * API-route-safe version of assertOrgAccess.
 * Returns the member record or null — never calls redirect().
 * Use this in API route handlers where redirect() produces a wrong HTTP response.
 */
